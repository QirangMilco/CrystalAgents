...
import { getCraftMainLogPath, resolveCraftLogsDir } from '@craft-agent/shared/config'
import type {
  MessagingLogContext,
  MessagingLogMeta,
  MessagingLogger,
 ...
 */
export const messagingGatewayLogPath = join(resolveCraftLogsDir(), 'messaging-gateway.log')
