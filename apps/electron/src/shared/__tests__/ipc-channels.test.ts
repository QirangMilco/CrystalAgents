...
const EXPECTED_CHANNELS: string[] = [
  ...
  'session:setModel',
  'sessions:cancel',
  'sessions:cancelAction',
  'sessions:clone',
  'sessions:command',
  'sessions:create',
  'sessions:createFromSummary',
  'sessions:delete',
  'sessions:export',
  ...
  'workspaceLegacy:getStatus',
  'workspaceLegacy:migrate',
  'workspaceRecordImport:getStatus',
  'workspaceRecordImport:run',
