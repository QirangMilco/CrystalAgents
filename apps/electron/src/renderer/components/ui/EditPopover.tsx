...
const EDIT_CONFIGS: Record<EditContextKey, (location: string) => EditConfig> = {
  ...
  'default-permissions': (location) => ({
    context: {
      ...
      context:
        'The user is editing the app-level default permissions file. ' +
  ...
  'preferences-notes': (location) => ({
    context: {
      ...
      context:
        'The user is editing the notes field in their preferences file. ' +
  ...
  'add-source': (location) => ({
    context: {
      ...
      context:
        ...
        'Follow the built-in sources documentation patterns. ' +
  ...
  'add-skill': (location) => ({
    context: {
      ...
      context:
        ...
        'Follow the built-in skills documentation patterns. ' +
  ...
  'edit-labels': (location) => ({
    context: {
      ...
      context:
        ...
        'Read the built-in labels documentation for the full format reference. ' +
        'Confirm clearly when done.',
    },
  ...
  'edit-tool-icons': (location) => ({
    context: {
      ...
      context:
        ...
        'The file is tool-icons.json in the app-level tool-icons directory. Icon image files live in the same directory. ' +
        ...
        'Read the built-in tool-icons documentation for the full format reference. ' +
  ...
  'automation-config': (location) => ({
    context: {
      ...
      context:
        ...
        'Read the built-in automations documentation for the full format reference. ' +
