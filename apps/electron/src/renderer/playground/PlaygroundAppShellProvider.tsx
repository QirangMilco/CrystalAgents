...
const playgroundValue: AppShellContextType = {
  ...
  onCloneSession: (async () => {
    throw new Error('[Playground] onCloneSession is not available')
  }) as AppShellContextType['onCloneSession'],
  onCreateSessionFromSummary: (async () => {
    throw new Error('[Playground] onCreateSessionFromSummary is not available')
  }) as AppShellContextType['onCreateSessionFromSummary'],
